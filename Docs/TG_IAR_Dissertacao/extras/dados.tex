...
\preambulo{\textbf{Trabalho de Graduação} apresentado ao Bacharelado em Engenharia de Instrumentação, Automação e Robótica (área de concentração: Sistemas Inteligentes), como parte dos requisitos necessários para a obtenção do Título de Engenheiro em Instrumentação, Automação e Robótica.}
% ---